...
CREATE TABLE team_players (
                              ...
                              player_id UUID NOT NULL REFERENCES player_stats(id) ON DELETE CASCADE,
...
CREATE TABLE matches (
                         ...
                         man_of_match_id UUID REFERENCES player_stats(id),
                         worst_player_id  UUID REFERENCES player_stats(id),
...
CREATE TABLE deliveries (
                            ...
                            bowler_id UUID REFERENCES player_stats(id),
                            ...
                            player_out_id UUID REFERENCES player_stats(id),
...
CREATE INDEX idx_players_user_id ON player_stats(user_id);
...
CREATE INDEX idx_deliveries_inning_id ON deliveries(inning_id);
CREATE INDEX idx_batting_scorecards_inning_id ON batting_scorecards(inning_id);
CREATE INDEX idx_bowling_scorecards_inning_id ON bowling_scorecards(inning_id);
